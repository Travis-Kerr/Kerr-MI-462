...
...along with the collection of badges and certificates from some of these different data applications that I achieved in these classes and work I have done on my own free time. The work will be divided up into folders labeled by the course abbreviation, MG220, then followed by the course name within the parentheses, (Data Analysis). The work I have gathered inside this Repository is everything I could find from my time taking these courses.
